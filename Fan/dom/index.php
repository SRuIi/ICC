        ...
        <div style="position:relative;background-color:#fff;margin:20px auto;box-shadow: 2px 2px 2px #f8f8f8;width:1400px;">
            ...
            <div id="toolbar" style="width:1100px;margin:0 auto;">
                <form id="formid" method="post"  action ="index.php">
                    <div class="my-container" style="display:inline-block;margin-left:820px;">
                        <div class="myText-content" style="display:inline-block;">
                            <input name="search" style="display:inline-block;border-border-right:0px;width:204px;" id="busNo" type="text" class="form-control" placeholder="输入币种名称如BTC">
                        </div>
                    </div>
                    <div class="myBtn-content" style="display:inline-block;">
                        <input id="search" type="submit" class="btn btn-primary" value="搜索" style="width:70px;margin-left:-1px;margin-bottom:2px;border-border-left:0px">
                    </div>
                </from>
            </div>
            ...
            <div style="width:1100px;margin:0 auto;padding-top:40px;padding-bottom:160px;">
                <table id="cryptocurrency-trade-coinmarket" class="table-no-bordered table-border">
                    ...
                    if(is_array($_POST)&&count($_POST)>0){
                        $json=file_get_contents("F:/dom.txt");
                        ...
                        $res = array_column('nameEN',$old,null);
                        $new = array();
                        foreach($res as $k=>$v){
                             if(in_array($k, $data)) $new[] = $v;
                        }
